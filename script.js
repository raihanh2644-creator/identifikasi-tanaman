...
const translations = {
    id: {
        ...
        aiServerError: "Server AI belum terhubung. Jalankan aplikasi lewat node local-dev.js.",
    ...
    en: {
        ...
        aiServerError: "AI server is not connected. Run the app through node local-dev.js.",
